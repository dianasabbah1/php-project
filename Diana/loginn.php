    ...
    if(isset($_POST['login'])){
        if(isset($_POST['email']) && $_POST['email']!="" &&
          isset($_POST['pass']) && $_POST['pass']!=""){
           ...
           $password= getPassForUserName($email);
         
           if ($password!=null){
                if( str_contains($password, $_POST['pass'])){
                    $message="login succsess";
                     $_SESSION["checklogin"]=$_POST["email"];
      ...
      <form class="login-form" action="" method="post">        
        <div class="login-wrap">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" placeholder="email" autofocus id="email"
              name="email">
            </div>
            <div class="input-group">
            ...
            <button  class="btn btn-info btn-lg btn-block" type="submit"
                    name="regist" id="regist"> <a href="regist.php">Regist</a></button>
        </div>
      </form>
